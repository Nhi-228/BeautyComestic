...
<html lang="en">
    ...
    <body>
        ...
        <section class="py-5" style="background-color: #f0f0ff;">
            <div class="container">
                <form id="formregister" action="RegisterServlet" method="post" style="max-width: 500px; margin: auto; border-collapse: collapse;">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="error" id="passworderror">Mật khẩu cần ít nhất 6 ký tự, có chữ hoa và ký tự đặc biệt</div>
                    </div>
                ...
                <% if (error != null) {%>
                <div class="error text-center" style="display: block;"><%= error%></div>
                <% }%>
