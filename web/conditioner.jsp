...
<head>
    ...
    <title>Conditioner Products</title>
...
<section class="cartelogy">
    <div class="container">
        <div class="cartelogy-top row">
            <p>Home</p><span>&#8594;</span><p>Hair Care</p><span>&#8594;</span><p>Conditioner</p>
        </div>
    </div>
    <div class="container">
        <div class="row">
            ...
            <div class="cartelogy-right row">
                ...
                <div class="cartegory-right-content">
                    <div class="cartegory-right-content-item" data-type="conditioner">
                        <img src="image/kematnuoc.jpg" alt="">
                        <h1>Dầu xả La Roche-Posay</h1>
