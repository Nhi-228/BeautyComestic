...
<section class="cartelogy">
    <div class="container">
        <div class="cartelogy-top row">
            <p>Home</p><span>&#8594;</span><p>Skincare</p><span>&#8594;</span><p>Tonner</p>
        </div>
    </div>
    <div class="container">
        <div class="row">
            ...
            <div class="cartelogy-right row">
                ...
                <div class="cartegory-right-content">
                    <div class="cartegory-right-content-item" data-type="tonner">
                        <img src="image/larochepodsay400ml.jpg" alt="">
                        <h1>Tonner La Roche-Posay</h1>
