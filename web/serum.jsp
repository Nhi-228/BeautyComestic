...
<section class="cartelogy">
    <div class="container">
        <div class="cartelogy-top row">
            <p>Home</p><span>&#8594;</span><p>Skincare</p><span>&#8594;</span><p>Serum</p>
        </div>
    </div>
    <div class="container">
        <div class="row">
            ...
            <div class="cartelogy-right row">
                ...
                <div class="cartegory-right-content">
                    <div class="cartegory-right-content-item" data-type="serum">
                        <img src="image/serumgiammun.jpg" alt="">
                        <h1>Serum Giảm Mụn</h1>
