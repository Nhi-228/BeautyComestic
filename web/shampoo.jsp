...
<section class="cartelogy">
    <div class="container">
        <div class="cartelogy-top row">
            <p>Home</p><span>&#8594;</span><p>Hair Care</p><span>&#8594;</span><p>Shampoo</p>
        </div>
    </div>
    <div class="container">
        <div class="row">
            ...
            <div class="cartelogy-right row">
                ...
                <div class="cartegory-right-content">
                    <div class="cartegory-right-content-item" data-type="shampoo">
                        <img src="image/srm(2).png" alt="">
                        <h1>Dầu gội La Roche-Posay</h1>
