...
<section class="cartelogy">
    <div class="container">
        <div class="cartelogy-top row">
            <p>Home</p><span>&#8594;</span><p>Skincare</p><span>&#8594;</span><p>Cleaning</p>
        </div>
    </div>
    <div class="container">
        <div class="row">
            ...
            <div class="cartelogy-right row">
                ...
                <div class="cartegory-right-content">
                    <div class="cartegory-right-content-item" data-type="cleaning">
                        <img src="image/srm(1).png" alt="">
                        <h1>Sữa rửa mặt La Roche-Posay</h1>
