...
<head>
    ...
    <title>Hair Mask Products</title>
...
<section class="cartelogy">
    <div class="container">
        <div class="cartelogy-top row">
            <p>Home</p><span>&#8594;</span><p>Hair Care</p><span>&#8594;</span><p>Hair mask</p>
        </div>
    </div>
    <div class="container">
        <div class="row">
            ...
            <div class="cartelogy-right row">
                ...
                <div class="cartegory-right-content">
                    <div class="cartegory-right-content-item" data-type="hairmask">
                        <img src="image/hairmask.jpg" alt="">
                        <h1>Hair Mask Dưỡng Tóc</h1>
